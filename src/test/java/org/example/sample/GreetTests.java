...
public class GreetTests {
    ...
    void testFetchGreeting(){
        Calendar morning = new Calendar.Builder().setTimeOfDay(10,0,0);
        Calendar afternoon = new Calendar.Builder().setTimeOfDay(14,0,0);
        Calendar evening = new Calendar.Builder().setTimeOfDay(19,0,0);
